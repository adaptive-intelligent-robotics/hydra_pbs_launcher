...
def _get_plugins() -> Tuple[List[Type["Executor"]], List["JobEnvironment"]]:
    ...
    executors: List[Type["Executor"]] = [pbs.PbsExecutor, local.LocalExecutor, debug.DebugExecutor]
    job_envs = [pbs.PbsJobEnvironment(), local.LocalJobEnvironment(), debug.DebugJobEnvironment()]
